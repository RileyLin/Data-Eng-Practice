...
SELECT 
    SUM(CASE WHEN drt.ride_type_name = 'Carpool' THEN 1 ELSE 0 END) * 100.0 / COUNT(DISTINCT frs.ride_segment_id) AS percentage
FROM fact_ride_segments frs 
LEFT JOIN fact_rides fr ON fr.ride_id = frs.ride_id
